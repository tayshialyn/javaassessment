...
public class PrinterHelper
{
        ...
        throws ParseException
    {
        ...
        name += scanner.nextLine(); // Fix found via https://stackoverflow.com/questions/4058912/scanner-doesnt-read-whole-sentence-difference-between-next-and-nextline-o
        ...
        while (!validDateEntered) {
            try {
                ...
                System.out.println("Invalid date entered. Enter student birth date(mm/dd/yyyy)");
            }
        }
